...
def make_prediction(VIDEO_FILE):
    ...
    # emotions_dict = extract_emotions("/home/malhaar/Downloads/rishit.mp4")
    emotions_dict = {'angry': 0.02, 'disgust': 0.0, 'fear': 0.05, 'happy': 0.16, 'neutral': 0.09, 'sad': 0.27, 'surprise': 0.41}
