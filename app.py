...
# Function to generate sample labels for demonstration
def generate_sample_labels():
    labels = {
        "Engaged": np.random.choice([1, 0], p=[0.8, 0.2]),
        "Excited": np.random.choice([1, 0], p=[0.7, 0.3]),
        "EyeContact": np.random.choice([1, 0], p=[0.8, 0.2]),
        "Smiled": np.random.choice([1, 0], p=[0.6, 0.4]),
        "SpeakingRate": np.random.choice([1, 0], p=[0.5, 0.5]),
        "NoFillers": np.random.choice([1, 0], p=[0.8, 0.2]),
        "Friendly": np.random.choice([1, 0], p=[0.7, 0.3]),
        "Paused": np.random.choice([1, 0], p=[0.6, 0.4]),
        "EngagingTone": np.random.choice([1, 0], p=[0.8, 0.2]),
        "StructuredAnswers": np.random.choice([1, 0], p=[0.7, 0.3]),
        "Calm": np.random.choice([1, 0], p=[0.8, 0.2]),
        "NotStressed": np.random.choice([1, 0], p=[0.7, 0.3]),
        "Focused": np.random.choice([1, 0], p=[0.6, 0.4]),
        "NotAwkward": np.random.choice([1, 0], p=[0.7, 0.3]),
    }
